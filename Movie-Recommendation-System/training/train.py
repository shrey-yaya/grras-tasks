...
if __name__ == "__main__":
    ...
    # Train model (Configuration 3: Fast Training - 10K movies, no SVD for speed)
    # This generates the files quickly so we can run the django app immediately.
    print("Initializing MovieRecommenderTrainer...")
    ...
    df, sim_matrix = trainer.train(
        ...
        max_movies=10000           # Limit to 10K movies for fast local execution
    )
